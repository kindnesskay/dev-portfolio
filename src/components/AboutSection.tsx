...
export default function AboutSection() {
  return (
    <section className="bg-blue-700 flex flex-col items-center w-full gap-12">
      <article className=" flex justify-center pt-20 px-4">
      ...
      <article className="flex justify-center w-full px-4">
        <div className="flex gap-8 max-w-6xl translate-y-12 max-lg:flex-col max-lg:gap-8 w-full ">
          <TextCard
